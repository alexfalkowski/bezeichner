...
func Register(params RegisterParams) error {
	...
	gih := nh.NewHandler[GenerateIdentifiersRequest](params.Mux, params.Marshaller, &generateErrorer{})
	if err := gih.Handle("POST", "/v1/generate", s.GenerateIdentifiers); err != nil {
		return err
	}

	mih := nh.NewHandler[MapIdentifiersRequest](params.Mux, params.Marshaller, &mapErrorer{})
