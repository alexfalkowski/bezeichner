...
type ServiceClient interface {
	...
	// and NotFound when mapper configuration is omitted, the application is not
	// configured, or any requested identifier is absent from the mapping.
...
func (c *serviceClient) GenerateIdentifiers(ctx context.Context, in *GenerateIdentifiersRequest, opts ...grpc.CallOption) (*GenerateIdentifiersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_GenerateIdentifiers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) MapIdentifiers(ctx context.Context, in *MapIdentifiersRequest, opts ...grpc.CallOption) (*MapIdentifiersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_MapIdentifiers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
